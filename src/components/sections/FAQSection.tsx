...
const FAQSection: React.FC = () => {
  ...
  const faqData = [
    {
      id: 1,
      question: 'האם צריך ניסיון במדיטציה כדי להשתתף?',
      answer: 'ממש לא. הריטריט פתוח למי שרוצה לעצור רגע, לנשום ולהיות. התרגולים מונגשים, מגוונים ומותאמים לכולם. נתחיל מהבסיסים ונלווה אותך לאורך כל הדרך בקצב שלך.',
      icon: '🧘‍♀️'
    },
    {
      id: 2,
      question: 'אפשר לבוא לבד?',
      answer: 'בהחלט! רבים ורבות מגיעים לבד – וזה אפילו חלק מהקסם. נוצר מרחב חברי, מכיל ומחובר. תמצאי את עצמך חלק מקהילה זמנית יפהפייה של אנשים שמחפשים כמוך רגעים של שקט ונוכחות.',
      icon: '🤗'
    },
    {
      id: 3,
      question: 'מה לגבי אוכל?',
      answer: 'הארוחות צמחוניות, עשירות ומפנקות – ומוגשות במקום. נותנים דגש על מזון איכותי, טרי ומזין שתומך בתהליך הפנימי. אפשר לציין רגישויות או מגבלות תזונה בטופס ההרשמה ונדאג להתאים.',
      icon: '🌱'
    },
    {
      id: 4,
      question: 'יש קליטה/וייפי במקום?',
      answer: 'יש קליטה מסוימת במקום – אבל אנחנו דווקא ממליצים לקחת פסק זמן מהמסך 😊. זה חלק מהחוויה: להתנתק מהרעש הדיגיטלי ולהתחבר לעצמנו ולטבע. אם יש צורך דחוף, תמיד אפשר למצוא פתרון.',
      icon: '📱'
    },
    {
      id: 5,
      question: 'אפשר לשלם בתשלומים?',
      answer: 'כן, בהחלט! יש אפשרות לתשלום בשני תשלומים שווים ללא ריבית. נקבע את זה יחד בשיחה האישית לפני ההרשמה. החשוב עבורנו שהמחיר לא יהיה מכשול בדרך לחוויה הזו.',
      icon: '💳'
    }
  ];
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="text-center mb-20 animate-fade-in-up">
            ...
            <p className="text-xl md:text-2xl text-text-secondary leading-relaxed max-w-3xl mx-auto">
              ...
              <br />
              כל שאלה נוספת – אנחנו כאן עבורכם 💚
            </p>
          </div>
